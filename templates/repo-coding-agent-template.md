...
- Check this repo's issues: `gh issue list --label "project:[repo-name]"` (work is tracked per-repo; portfolio-level organization is via user-level GitHub Projects (v2) boards).
