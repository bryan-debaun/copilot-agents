...
handoffs:
  - label: 'from-architect'
    ...
    prompt: Provide context about test requirements, acceptance criteria, and test environment expectations
  - label: 'from-coder'
    agent: DeBaun Coder
    prompt: Provide context about work implementation details and any code changes affecting tests
---
